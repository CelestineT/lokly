      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input id="nom" name="nom" type="text" required defaultValue={bien.nom}
          ...
          <div>
            ...
            <input id="adresse" name="adresse" type="text" required defaultValue={bien.adresse}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input id="ville" name="ville" type="text" required defaultValue={bien.ville}
                className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              ...
              <input id="code_postal" name="code_postal" type="text" required defaultValue={bien.code_postal}
                className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select id="type" name="type" required defaultValue={bien.type}
            ...
            <div>
              ...
              <select id="type_location" name="type_location" required defaultValue={bien.type_location}
                className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
